...
function EventsS2(){
    return(
        <Container fluid className="events-s2 minh-75vh d-flex align-items-start py-5">
                    ...
                    <Card className="shadow mb-3">
                        ...
                        <Card.Body className="card-body collapse show" id="filters">
                            ...
                            <InputGroup size="sm" className="mb-2 ps-3 small">       
                                <InputGroup.Text className="bg-white text-secondary border-end-0">Date:</InputGroup.Text> 
                                <Form.Control type="date" className="text-end border-start-0"/>
                            </InputGroup>   
